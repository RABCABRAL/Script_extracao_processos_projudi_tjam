...
1.  **Faça Login:** Acesse o sistema Projudi TJAM.
2.  **Navegue até a Lista:**
    - Na tela "Mesa do Advogado Particular", clique na guia **Processos**.
    - Vá em **1º Grau** e depois em **Ativos**.
    - Isso carregará a lista inicial com os primeiros 20 processos. O script lidará com as demais páginas ("N" paginações) automaticamente.
3.  **Abra o Console do Desenvolvedor:**
    - Pressione a tecla `F12`.
    - Ou clique com o botão direito e selecione **Inspecionar**, depois a aba **Console**.
3.  **Injete o Script:**
